<?php /* Smarty version 2.6.20, created on 2017-12-11 12:37:53
         compiled from search_videos.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 't', 'search_videos.tpl', 5, false),array('function', 'url', 'search_videos.tpl', 12, false),array('modifier', 'escape', 'search_videos.tpl', 75, false),array('modifier', 'clean', 'search_videos.tpl', 82, false),array('insert', 'thumb_path', 'search_videos.tpl', 84, false),array('insert', 'duration', 'search_videos.tpl', 88, false),array('insert', 'time_range', 'search_videos.tpl', 95, false),array('insert', 'adv', 'search_videos.tpl', 141, false),)), $this); ?>
<div class="container">

	<div class="well well-filters">
			<div class="pull-left">
				<h4><?php echo smarty_function_t(array('c' => 'search.title'), $this);?>
<span class="hidden-xs hidden-sm"> - <?php echo smarty_function_t(array('c' => 'global.videos'), $this);?>
</span></h4>
			</div>
	...
	<div class="row">
		<div class="col-md-9 col-sm-8">
			...
			<div class="well well-sm">
				<span class="m-b-5 title-truncate"><?php echo smarty_function_t(array('c' => 'search.results_for'), $this);?>
: <span class="text-white"><?php echo ((is_array($_tmp=$this->_tpl_vars['search_query'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</span></span>
...
.</span>
		...
		<div class="col-md-3 col-sm-4">
			<div class="list-group">
				<a href="<?php echo smarty_function_url(array('base' => 'search/videos','strip' => 'c','value' => ''), $this);?>
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
				<a href="<?php echo smarty_function_url(array('base' => "search/videos/".($this->_tpl_vars['categories'][$this->_sections['i']['index']]['slug']),'strip' => 'c','value' => ''), $this);?>
" <?php if ($this->_tpl_vars['category'] == $this->_tpl_vars['categories'][$this->_sections['i']['index']]['CHID']): ?>class="list-group-item active"<?php else: ?>class="list-group-item"<?php endif; ?>>
			...
			<div class="well ad-body">
				...
				<?php require_once(SMARTY_CORE_DIR . 'core.run_insert_handler.php');
echo smarty_core_run_insert_handler(array('args' => array('name' => 'adv', 'assign' => 'adv', 'group' => 'search_right')), $this); ?>
...
<?php endif; ?>
	...
	<div class="well ad-body">
		...
		<?php require_once(SMARTY_CORE_DIR . 'core.run_insert_handler.php');
echo smarty_core_run_insert_handler(array('args' => array('name' => 'adv', 'assign' => 'adv', 'group' => 'search_bottom')), $this); ?>
