<?php /* Smarty version 2.6.20, created on 2017-12-11 09:54:46
         compiled from user_favorite_videos.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 't', 'user_favorite_videos.tpl', 15, false),array('modifier', 'clean', 'user_favorite_videos.tpl', 33, false),array('modifier', 'escape', 'user_favorite_videos.tpl', 35, false),array('insert', 'thumb_path', 'user_favorite_videos.tpl', 35, false),array('insert', 'duration', 'user_favorite_videos.tpl', 39, false),array('insert', 'time_range', 'user_favorite_videos.tpl', 53, false),)), $this); ?>
<div class="container">
	<div class="row">
		<div class="col-md-4">
...
<?php if ($_SESSION['language'] == 'en_US'): ?>&#39;s<?php endif; ?> <?php echo smarty_function_t(array('c' => 'user.FAVORITE_VIDEOS'), $this);?>
...
/favorite/videos?clear=yes" title="<?php echo smarty_function_t(array('c' => 'favorite_videos.clear'), $this);?>
" onclick="javascript:return confirm('<?php echo smarty_function_t(array('c' => 'user.fav_videos_all'), $this);?>
...
%<?php endif; ?></b>
			...
			<?php else: ?>
				<div class="panel-body">
					<span class="text-danger"><?php echo smarty_function_t(array('c' => 'user.fav_videos_none'), $this);?>
.</span>
				</div>
			<?php endif; ?>	
			</div>	
