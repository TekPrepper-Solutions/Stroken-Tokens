<?php /* Smarty version 2.6.20, created on 2017-12-11 12:42:08
         compiled from user_favorite_games.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 't', 'user_favorite_games.tpl', 15, false),array('modifier', 'clean', 'user_favorite_games.tpl', 33, false),array('modifier', 'escape', 'user_favorite_games.tpl', 35, false),array('insert', 'time_range', 'user_favorite_games.tpl', 48, false),)), $this); ?>
<div class="container">
	<div class="row">
		<div class="col-md-4">
...
<?php if ($_SESSION['language'] == 'en_US'): ?>&#39;s<?php endif; ?> <?php echo smarty_function_t(array('c' => 'user.FAVORITE_GAMES'), $this);?>
...
/favorite/games?clear=yes" title="<?php echo smarty_function_t(array('c' => 'favorite_games.clear'), $this);?>
" onclick="javascript:return confirm('<?php echo smarty_function_t(array('c' => 'user.fav_games_all'), $this);?>
...
?>
									<div id="favorite_game_<?php echo $this->_tpl_vars['favorites'][$this->_sections['i']['index']]['GID']; ?>
" class="col-sm-4 m-b-15">
										<div class="thumb-overlay">
											<a href="<?php echo $this->_tpl_vars['relative']; ?>
/game/<?php echo $this->_tpl_vars['favorites'][$this->_sections['i']['index']]['GID']; ?>
...
/media/games/tmb/<?php echo $this->_tpl_vars['favorites'][$this->_sections['i']['index']]['GID']; ?>
...
" class="img-responsive <?php if ($this->_tpl_vars['favorites'][$this->_sections['i']['index']]['type'] == 'private'): ?>img-private<?php endif; ?>" />
											...
											<?php if (isset ( $_SESSION['uid'] ) && $_SESSION['uid'] == $this->_tpl_vars['user']['UID']): ?>
												<div class="actions">
													<a href="#remove_game" id="remove_game_from_favorite_<?php echo $this->_tpl_vars['favorites'][$this->_sections['i']['index']]['GID']; ?>
...
echo smarty_core_run_insert_handler(array('args' => array('name' => 'time_range', 'assign' => 'addtime', 'time' => $this->_tpl_vars['favorites'][$this->_sections['i']['index']]['addtime'])), $this); ?>
										...
										<div class="video-views pull-left">
											<?php echo $this->_tpl_vars['favorites'][$this->_sections['i']['index']]['total_plays']; ?>
 <?php if ($this->_tpl_vars['favorites'][$this->_sections['i']['index']]['total_plays'] == '1'): ?><?php echo smarty_function_t(array('c' => 'global.play'), $this);?>
