<?php /* Smarty version 2.6.20, created on 2017-12-11 12:38:54
         compiled from user_subscriptions.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 't', 'user_subscriptions.tpl', 14, false),array('function', 'url', 'user_subscriptions.tpl', 21, false),array('modifier', 'escape', 'user_subscriptions.tpl', 38, false),)), $this); ?>
<div class="container">
	<div class="row">
		<div class="col-md-4">
...
<?php if ($_SESSION['language'] == 'en_US'): ?>&#39;s<?php endif; ?> <?php echo smarty_function_t(array('c' => 'user.subscriptions'), $this);?>
				...
				<div class="panel-body">
					<?php if ($this->_tpl_vars['subscriptions']): ?>
						<div class="btn-group">
							<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"><?php if ($this->_tpl_vars['order'] == 'subscribe_date'): ?><?php echo smarty_function_t(array('c' => 'user.recent_subscriptions'), $this);?>
...
<?php endif; ?> <span class="caret"></span></button>
							<ul class="dropdown-menu">
								<li <?php if ($this->_tpl_vars['order'] == 'subscribe_date'): ?>class="active"<?php endif; ?>><a href="<?php echo smarty_function_url(array('base' => "user/".($this->_tpl_vars['username'])."/subscriptions",'strip' => 'o','value' => 'subscribe_date'), $this);?>
"><?php echo smarty_function_t(array('c' => 'user.recent_subscriptions'), $this);?>
</a></li>
								<li <?php if ($this->_tpl_vars['order'] == 'recent_users'): ?>class="active"<?php endif; ?>><a href="<?php echo smarty_function_url(array('base' => "user/".($this->_tpl_vars['username'])."/subscriptions",'strip' => 'o','value' => 'recent_users'), $this);?>
"><?php echo smarty_function_t(array('c' => 'user.recent_users'), $this);?>
</a></li>
								<li <?php if ($this->_tpl_vars['order'] == 'recent_logins'): ?>class="active"<?php endif; ?>><a href="<?php echo smarty_function_url(array('base' => "user/".($this->_tpl_vars['username'])."/subscriptions",'strip' => 'o','value' => 'recent_logins'), $this);?>
"><?php echo smarty_function_t(array('c' => 'user.recent_logins'), $this);?>
</a></li>
								<li <?php if ($this->_tpl_vars['order'] == 'username'): ?>class="active"<?php endif; ?>><a href="<?php echo smarty_function_url(array('base' => "user/".($this->_tpl_vars['username'])."/subscriptions",'strip' => 'o','value' => 'username'), $this);?>
"><?php echo smarty_function_t(array('c' => 'global.username'), $this);?>
 ...
 <span class="text-white"><?php echo $this->_tpl_vars['subscriptions_total']; ?>
</span> <?php echo smarty_function_t(array('c' => 'subscription.subscriptions'), $this);?>
.
						</div>
						<div class="row">
...
?>
								<div id="subscription_<?php echo $this->_tpl_vars['subscriptions'][$this->_sections['i']['index']]['UID']; ?>
...
's avatar" class="img-responsive"/>
										...
										<?php if (isset ( $_SESSION['uid'] ) && $_SESSION['uid'] == $this->_tpl_vars['user']['UID']): ?>
											<div class="actions">
												<a href="#remove_subscription" id="remove_subscription_<?php echo $this->_tpl_vars['subscriptions'][$this->_sections['i']['index']]['UID']; ?>
...
" class="btn btn-danger remove-btn visible-xs"><i class="glyphicon glyphicon-remove"></i> <?php echo smarty_function_t(array('c' => 'global.remove'), $this);?>
						...
						<?php endif; ?>
					<?php else: ?>
						<span class="text-danger"><?php echo smarty_function_t(array('c' => 'user.subscriptions_none'), $this);?>
.</span>
					<?php endif; ?>
				</div>				
			</div>	
