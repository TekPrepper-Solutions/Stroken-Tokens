<?php /* Smarty version 2.6.20, created on 2018-02-19 00:16:55
         compiled from channels_listalbum.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'channels_listalbum.tpl', 105, false),)), $this); ?>
...
>
									<div class="pull-left">
										<div class="btn-group"> <a class="btn dropdown-toggle btn-demo-space" data-toggle="dropdown" href="#">Order by <span id="sort_items"><?php if ($this->_tpl_vars['option']['sort'] == 'name'): ?>Name<?php elseif ($this->_tpl_vars['option']['sort'] == 'total_albums'): ?>Total Albums<?php else: ?>ID<?php endif; ?></span> <span class="caret"></span> </a>
...
?>
											<div id="item-<?php echo $this->_tpl_vars['channels'][$this->_sections['i']['index']]['CID']; ?>
" class="item-main-container category">
												<div class="item-col-left">
													<div class="item-main">
														<div class="item-thumb">
															<div class="thumb-overlay">	
																<a href="albums.php?m=all&CID=<?php echo $this->_tpl_vars['channels'][$this->_sections['i']['index']]['CID']; ?>
">
																	<img id="thumb-<?php echo $this->_tpl_vars['channels'][$this->_sections['i']['index']]['CID']; ?>
" src="<?php echo $this->_tpl_vars['baseurl']; ?>
/media/categories/album/<?php echo $this->_tpl_vars['channels'][$this->_sections['i']['index']]['CID']; ?>
.jpg" class="img-responsive">
																</a>
																<div class="item-id">
																	<b>ID</b> <?php echo $this->_tpl_vars['channels'][$this->_sections['i']['index']]['CID']; ?>

																</div>
																<div id="photos-loading-<?php echo $this->_tpl_vars['channels'][$this->_sections['i']['index']]['CID']; ?>
												...
												<div class="item-col-right">
													<div class="item-details">
														<div class="item-title">
															<a href="albums.php?m=all&CID=<?php echo $this->_tpl_vars['channels'][$this->_sections['i']['index']]['CID']; ?>
">
																<span class="text-info" id="title-<?php echo $this->_tpl_vars['channels'][$this->_sections['i']['index']]['CID']; ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['channels'][$this->_sections['i']['index']]['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
														...
														<div class="row">						
															<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
																...
																<span id="slug-<?php echo $this->_tpl_vars['channels'][$this->_sections['i']['index']]['CID']; ?>
"><?php echo $this->_tpl_vars['channels'][$this->_sections['i']['index']]['slug']; ?>
</span>
															</div>
															<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
																<div class="d-label">Albums</div>
																<a id="total-items-<?php echo $this->_tpl_vars['channels'][$this->_sections['i']['index']]['CID']; ?>
" href="albums.php?m=all&CID=<?php echo $this->_tpl_vars['channels'][$this->_sections['i']['index']]['CID']; ?>
"><?php echo $this->_tpl_vars['channels'][$this->_sections['i']['index']]['total_albums']; ?>
</a>
															</div>
														</div>
													</div>
												...
												<div class="item-actions">																									
													<div class="btn-group">
														<div class="btn-group">
															<a id="delete__category_<?php echo $this->_tpl_vars['channels'][$this->_sections['i']['index']]['CID']; ?>
" class="btn btn-success" data-toggle="dropdown" href="#" alt="Delete" title="Delete"><i class="fa fa-trash-o"></i></a>
															<ul class="dropdown-menu">
																<li><a id="delete_category_Album_<?php echo $this->_tpl_vars['channels'][$this->_sections['i']['index']]['CID']; ?>
" href="#">Delete</a></li>
															</ul>
														</div>
														<a id="edit_category_Album_<?php echo $this->_tpl_vars['channels'][$this->_sections['i']['index']]['CID']; ?>
" class="btn btn-success" href="#" alt="Edit" title="Edit"><i class="fa fa-pencil"></i></a>
														<a id="thumb_category_Album_<?php echo $this->_tpl_vars['channels'][$this->_sections['i']['index']]['CID']; ?>
