<?php /* Smarty version 2.6.20, created on 2017-12-10 20:57:20
...
<br />
	...
	<?php if ($this->_tpl_vars['warnings']): ?>
		<div class="alert">
			...
			<?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['warnings']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['i']['show'] = true;
$this->_sections['i']['max'] = $this->_sections['i']['loop'];
$this->_sections['i']['step'] = 1;
$this->_sections['i']['start'] = $this->_sections['i']['step'] > 0 ? 0 : $this->_sections['i']['loop']-1;
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
				<?php echo $this->_tpl_vars['warnings'][$this->_sections['i']['index']]; ?>
<br />
			<?php endfor; endif; ?>
		</div>
	<?php endif; ?>
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
				<?php echo $this->_tpl_vars['info'][$this->_sections['i']['index']]; ?>
<br />
			<?php endfor; endif; ?>
		</div>
	<?php endif; ?>	
