<?php /* Smarty version 2.6.20, created on 2017-12-11 02:23:16
         compiled from index_bandwidth.tpl */ ?>
								...
								<div class="col-lg-6 col-lg-offset-3 col-md-12">
									<div class="row">
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<div class="radio p-t-9">
													<input id="guest_limit_y" type="radio" name="guest_limit" value="1" <?php if ($this->_tpl_vars['guest_limit'] == '1'): ?>checked="checked"<?php endif; ?> class="radio-enabled">
													<label for="guest_limit_y">Yes</label>
													<input id="guest_limit_n" type="radio" name="guest_limit" value="0" <?php if ($this->_tpl_vars['guest_limit'] == '0'): ?>checked="checked"<?php endif; ?> class="radio-disabled">
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="guest_bandwidth" type="text" value="<?php echo $this->_tpl_vars['guest_bandwidth']; ?>
" class="form-control <?php if ($this->_tpl_vars['err']['guest_bandwidth']): ?>error<?php endif; ?>">
